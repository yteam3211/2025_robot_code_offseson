...
public interface ArmPitchIO {
    ...
    public static class ArmPitchInputs {    
        /** look https://github.wpilib.org/allwpilib/docs/release/java/edu/wpi/first/units/Units.html
     ...
     * @apiNote check https://docs.advantagekit.org/getting-started/what-is-advantagekit/ for more info
     *  */
    ...
    */
    @Deprecated
    public default Command setSpeedPos(double speed){return Commands.runOnce(()->{});}
    /**set motor to pos 
     * @param pos the pos you want the arm to move to take a angle type pramte https://github.wpilib.org/allwpilib/docs/release/java/edu/wpi/first/units/Units.html
    */
    public default Command setPos(Angle pos){return Commands.runOnce(()->{});}
}